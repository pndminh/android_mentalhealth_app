...
class PatientHomepageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.setOnItemClickListener(){ adapterView, view, i, l ->
            ...
            intent.putExtra("doctorName", selectedItem.name)
            intent.putExtra("doctorField", selectedItem.field)
            intent.putExtra("doctorImg", selectedItem.image)
            intent.putExtra("doctorEmail", selectedItem.email)
